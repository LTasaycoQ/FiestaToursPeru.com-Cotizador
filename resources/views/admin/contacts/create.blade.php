...
<div class="page-header">
    <div class="page-title">Nuevo Contacto</div>
    <div class="page-sub">Registra un nuevo contacto en el sistema</div>
</div>
    ...
    <div class="card">
        <div class="card-header">
            <div>
                ...
                <div class="card-sub">Completa la información del nuevo contacto</div>
            </div>
        ...
        <form action="{{ route('admin.contacts.store') }}" method="POST">
            ...
            <div class="form-grid" style="margin-bottom:1.4rem">
                <div class="form-field">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                           placeholder="Nombre" maxlength="100" required autofocus>
                </div>
                <div class="form-field">
                ...
                <div class="form-field">
                    ...
                    <input type="text" name="qualification" value="{{ old('qualification') }}"
                           placeholder="Ej: Gerente, Agente..." maxlength="30">
                </div>
            </div>
            ...
            <div class="form-grid" style="margin-bottom:1.4rem">
                ...
                <div class="form-field" style="grid-column:1">
                    ...
                    <input type="text" name="first_phone" value="{{ old('first_phone') }}"
                           placeholder="+51 999 999 999" maxlength="20">
                </div>
                <div class="form-field">
                    ...
                    <select name="id_client">
                        ...
                        @foreach($clients as $cl)
                            <option value="{{ $cl->id_client }}"
                                {{ old('id_client') == $cl->id_client ? 'selected' : '' }}>
                                {{ $cl->name_client }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div style="display:flex;gap:.8rem;padding-top:1rem;border-top:1px solid #f1f5f9">
                <button type="submit" class="btn btn-primary">
                    <i class="ti ti-plus" style="font-size:14px"></i> Crear contacto
                </button>
